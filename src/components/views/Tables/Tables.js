...
const Tables = () => (
  <Paper className={styles.component}>
    <Button className={styles.btn} variant='contained' color='primary' component={Link} to={`${process.env.PUBLIC_URL}/booking/new`}><AddIcon />Add new book</Button>
    <Button className={styles.btn} variant='contained' color='primary' component={Link} to={`${process.env.PUBLIC_URL}/events/new`}><AddIcon />Add new event</Button>
